        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {!isLoading && posts.length > 0 ? posts.map((post, idx) => (
            ...
            >
              ...
              <Card className="relative overflow-hidden p-0 border-border/50 bg-card hover:border-accent/30 transition-all duration-500 rounded-[2.5rem] flex flex-col h-full shadow-sm hover:shadow-2xl hover:-translate-y-2">
                <div className="p-8 pb-0">
                  <div className="flex items-center justify-between mb-6">
                    <span className="px-4 py-1.5 rounded-full bg-accent/10 text-accent text-[10px] font-black uppercase tracking-widest border border-accent/10">
                      {post.category_name}
                    </span>
                    <div className="flex flex-col items-end gap-1">
                      <div className="w-10 h-10 rounded-2xl bg-accent/10 flex items-center justify-center text-xl group-hover:bg-accent group-hover:text-white transition-colors">
